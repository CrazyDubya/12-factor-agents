...
# Test multiple Ollama models and generate comparison

echo "=========================================="
echo "MULTI-MODEL TESTING SUITE"
echo "=========================================="
echo ""
...
# Create modified comprehensive_auto_test.py that accepts model as argument
cat > test_single_model.py << 'PYTHON_SCRIPT'
#!/usr/bin/env python3
"""
...
echo ""
echo "✓ Multi-model testing complete!"
echo "  View comparison: open test_results/comparison_report_*.html"
